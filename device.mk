...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/usecaseKvManager.xml:$(TARGET_COPY_OUT_VENDOR)/etc/usecaseKvManager.xm \
    $(LOCAL_PATH)/configs/dirac/interface.json:$(TARGET_COPY_OUT_VENDOR)/etc/dirac/interface.json
